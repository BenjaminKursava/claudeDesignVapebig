    ...
    <section style={{ padding: '40px 32px 64px', background: 'var(--paper)' }}>
      <div style={{ maxWidth: 1180, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 56, alignItems: 'center' }}>
        <div>
          ...
          <button onClick={() => onNav?.('contact')} className="btn btn-ink" style={{ marginTop: 22, padding: '14px 22px', borderRadius: 999, fontSize: 14 }}>Visit our shop <Icon name="arrow-tr" size={14} /></button>
        </div>
        ...
        <div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginTop: 28 }}>
            {[
              ...
              { i: 'mail', l: 'Email', v: 'help@vapebig.co.uk' },
              { i: 'chat', l: 'Live chat', v: 'Chat now — typically replies in 4 mins' },
              { i: 'pin', l: 'Visit', v: '61 Bridge Street, Kington, HR5 3DJ' },
            ].map(c => (
          ...
          <div style={{ marginTop: 28, padding: 18, background: 'var(--ink-950)', color: '#fff', borderRadius: 14, display: 'flex', gap: 12, alignItems: 'center' }}>
            ...
            <div>
              <div className="display" style={{ fontWeight: 700, fontSize: 14 }}>Opening hours</div>
              <div style={{ fontSize: 12.5, color: '#a89cb8', marginTop: 2 }}>Mon–Fri 10:00–17:00 · Sat 10:00–16:00 · Sun closed</div>
            </div>
          </div>
        </div>
        <div>
