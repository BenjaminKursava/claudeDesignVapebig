...
const HomeDesktop = ({ onNav }) => {
  const banners = [
    { eyebrow: 'New arrival', title: 'Hayati Pro Ultra Plus 25K', sub: '25,000 puffs · 6 flavour modes · in stock now', cta: 'Shop Hayati', img: window.__resources.heroHayatiPromax, bg: 'linear-gradient(120deg, #1a1320 0%, #c2380a 60%, #ff5e1f 100%)', accent: '#ffc940' },
